...
![](img/reading/reading-1.webp){:  style="display: block; margin: 0 auto; max-width:50%; height:auto;" }

#### _¡Hola, Lola!_ của Juan Fernandez

![](img/reading/reading-2.webp){:  style="display: block; margin: 0 auto; max-width:50%; height:auto;" }

#### _Una aventura de WhatsApp_ của María Danader

![](img/reading/reading-3.webp){:  style="display: block; margin: 0 auto; max-width:50%; height:auto;" }

#### _Viaje a Madrid_ của Cristina López

![](img/reading/reading-4.webp){:  style="display: block; margin: 0 auto; max-width:50%; height:auto;" }
...
![Book Cover of Spanish Story La Chica Del Bar with mention: A2 reader, 2,622 words](img/reading/reading-5.webp){:  style="display: block; margin: 0 auto; max-width:50%; height:auto;" }

#### *La profe de español* của Juan Fernández

![](img/reading/image.png){:  style="display: block; margin: 0 auto; max-width:50%; height:auto;" }

#### *Año nuevo, vida nueva* của Juan Fernández

![Año nuevo, vida nueva title on dark background with photo of man from the back](img/reading/reading-6.webp){:  style="display: block; margin: 0 auto; max-width:50%; height:auto;" }
...
![Me voy o me quedo_ - Spanish Intermediate (Spanish Edition) của Juan Fernández](img/reading/reading-7.webp){:  style="display: block; margin: 0 auto; max-width:50%; height:auto;" }


#### *Misterio en la biblioteca*: của María Danader 

![Misterio en la biblioteca: của María Danader](img/reading/reading-8.webp){:  style="display: block; margin: 0 auto; max-width:50%; height:auto;" }


#### Un café en Buenos Aires: Una aventura con sabor a tango của Estefanía Quevedo Lusby 

![Un café en Buenos Aires_ Una aventura con sabor a tango của Estefanía Quevedo Lusby](img/reading/reading-9.webp){:  style="display: block; margin: 0 auto; max-width:50%; height:auto;" }

#### Sobreviví (6-book series) của Lauren Tarshis

![](img/reading/reading-10.webp){:  style="display: block; margin: 0 auto; max-width:50%; height:auto;" }
